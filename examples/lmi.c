/* An example of how to use ecvxcone: Linear Matrix Inequalities (LMIs) */
...
void benchmark(int iterations, bool verbose, double threshold, bool random) {
